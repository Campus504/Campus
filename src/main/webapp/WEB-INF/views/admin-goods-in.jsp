	...
	<div class="main-container">
				...
				<div class="col-md-6 col-sm-12">
					...
					<nav aria-label="breadcrumb" role="navigation">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">입고내용</li>
						</ol>
					</nav>
				</div>
		...
		<div class="mb-9">
			...
			<ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
				...
				<li class="nav-item"><a class="nav-link" href="#">신상품 <span
						class="text-700 fw-semi-bold">(6)</span></a></li>
				<li class="nav-item"><a class="nav-link" href="#">입고 품목 <span
						class="text-700 fw-semi-bold">(6,810)</span></a></li>
				<li class="nav-item"><a class="nav-link" href="#">업체 정보 <span
						class="text-700 fw-semi-bold">(8)</span>
				</a></li>
					...
					<div class="row g-3">
						...
						<div class="col-auto">
							...
							<button class="btn btn-primary">
								<span class="fas fa-plus me-2"></span>Add goods
							</button>
						</div>
					</div>
				</div>
				<div
							...
							<thead>
								<tr>
									...
									<th class="sort align-middle pe-5" scope="col"
										data-sort="customer" style="width: 10%;">상품명</th>
									<th class="sort align-middle pe-5" scope="col"
										data-sort="email" style="width: 20%;">정보</th>
									<th class="sort align-middle text-end" scope="col"
										data-sort="total-orders" style="width: 10%">수량</th>
									<th class="sort align-middle text-end ps-3" scope="col"
										data-sort="total-spent" style="width: 10%">가격</th>
									<th class="sort align-middle ps-7" scope="col"
										data-sort="city" style="width: 25%;">입고처</th>
									<th class="sort align-middle text-end" scope="col"
										data-sort="last-seen" style="width: 15%;">입고 시기</th>
									<th class="sort align-middle text-end pe-0" scope="col"
										data-sort="last-order" style="width: 10%;">최근 주문 시기</th>
								</tr>
							</thead>
							<tbody class="list" id="table-latest-review-body">
								...
								<tr
									...
									<td class="customer align-middle white-space-nowrap pe-5"><a
										class="d-flex align-items-center" href="#!">
											<div class="avatar avatar-m">
												<img class="rounded-circle"
													src="../../../assets/img/team/avatar-placeholder.png"
													alt="" />
											</div>
									...
									<td
										...
										21567</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Manchester</td>
									<td
								...
								<tr
									...
									<td class="customer align-middle white-space-nowrap pe-5"><a
										class="d-flex align-items-center" href="#!">
											...
											<p class="mb-0 ms-3 text-1100 fw-bold">Stanly
												Drinkwater</p>
									</a></td>
									<td class="email align-middle white-space-nowrap pe-5"><a
										class="fw-semi-bold text-1100"
									...
									<td
										...
										19872</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Smallville</td>
									<td
								...
								<tr
									...
									<td
										...
										17996</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Metropolis</td>
									<td
								...
								<tr
									...
									<td
										...
										16785</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Central
										city</td>
									<td
								...
								<tr
									...
									<td
										...
										14956</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Gotham</td>
									<td
										class="last-seen align-middle white-space-nowrap text-700 text-end">2
										weeks ago</td>
									<td
								...
								<tr
									...
									<td
										...
										12509</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Vancouver</td>
									<td
								...
								<tr
									...
									<td
										...
										11003</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Viena</td>
									<td
										class="last-seen align-middle white-space-nowrap text-700 text-end">6
										min ago</td>
									<td
								...
								<tr
									...
									<td
										...
										7897</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Bangalore</td>
									<td
								...
								<tr
									...
									<td
										...
										7781</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Chittagong</td>
									<td
								...
								<tr
									...
									<td
										...
										7825</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">New
										Jersey</td>
									<td
								...
								<tr
									...
									<td
										...
										8967</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Charlotte</td>
									<td
								...
								<tr
									...
									<td
										...
										14587</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Artesia</td>
									<td
										class="last-seen align-middle white-space-nowrap text-700 text-end">2
										day ago</td>
									<td
								...
								<tr
									...
									<td
										...
										45697</td>
									<td
										class="city align-middle white-space-nowrap text-900 ps-7">Philadelphia</td>
									<td
										class="last-seen align-middle white-space-nowrap text-700 text-end">12
										hours ago</td>
									<td
					...
					<div
						...
						<div class="col-auto d-flex">
							...
							</a><a class="fw-semi-bold d-none" href="#!" data-list-view="less">View
