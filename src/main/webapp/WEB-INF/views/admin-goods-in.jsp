		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<div class="clearfix">
						<h4 class="text-blue h4">입고 등록을 통해 등록된 상품을 확인 할 수 있는 리스트입니다.</h4>
						<p class="mb-30">입고 리스트를 확인해 주세요</p>
					</div>
										...
										<table class="checkbox-datatable table nowrap dataTable no-footer dtr-inline" id="DataTables_Table_3" role="grid" aria-describedby="DataTables_Table_3_info">
											<thead>
												<tr role="row">
													...
													<th class="sorting_asc" tabindex="0" rowspan="1" colspan="1">입고코드</th>
