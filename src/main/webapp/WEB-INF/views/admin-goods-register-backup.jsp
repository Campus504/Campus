...
<body>
	...
	<form class="mb-9">
            ...
            <h2 class="mb-2"> 상품 등록 </h2>
            <h5 class="text-700 fw-semi-bold">원하시는 상품을 등록해주세요!</h5>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-sm-6 col-xl-12">
                            <div class="mb-4">
                              ...
                              <input class="form-control mb-3" type="text" placeholder="Collection" />
                            </div>
                          </div>
                          ...
                          <div class="col-12 col-sm-6 col-xl-12">
                            <div>
                              <div class="d-flex flex-wrap justify-content-between mb-2">
                                <h5>Tags</h5>
                                <a class="fw-bold fs--1" href="#!">View all tags</a>
