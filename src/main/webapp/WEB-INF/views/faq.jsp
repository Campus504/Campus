...
<body>
  ...
  <div>
    <p>
    구성품으로 숯받침, 숯통 2개, 그릴, 갈매기판, 토치, 케리백, 들게가 함께 배송됩니다.
    </p>
  </div>
  <h3>사용한 장비는 반납 시 청소를 해야 하나요?</h3>
  <div>
    <p>
    깨끗이 사용하시고 반납하시기 바랍니다. 캠핑장비는 특별한 경우가 아니면 더러워질 일이 없을 뿐더러 바베큐 그릴이나 코펠을 제외하고는 청소가 어렵지도 않고
    시간이 오래 걸리지도 않으므로 조금만 시간을 할애애 주시면 감사하겠습니다. 특히 바베큐 그릴이나 코펠의 경우, 사용 후 청소를 하지 않고 보내시게 되면
    변색이나 제품의 이상을 초래할 뿐만 아니라 기름이나 국물이 흘러 다른 대여품 손상의 원인이 되기도 합니다. 꼭 주의 바랍니다.
    </p>
    <ul>
    </ul>
  </div>
  ...
  <div>
    <p>
   장비 대여주문은 실 사용일 2일 전 까지는 하셔야 합니다.
   예를 들어 토요일부터 사용 예정이라면 목요일 오후 3시 이전에는 주문을 하셔야 금요일에 제품을 픽업하실 수 있습니다.
   행사나 여행이 있으시다면 미리 미리 예약하시는 것을 추천합니다.
    </p>
    <p>
