...
<link rel="stylesheet" type="text/css"
	href="/campus/resources/assets/css/theme.min.css">
<link rel="stylesheet" type="text/css"
									...
									<div class="col-12 col-sm-auto mb-sm-2">
										<div class="avatar avatar-5xl">
											<img class="rounded-circle"
												src="../../../assets/img/team/15.png" alt="" />
										</div>
									</div>
							...
							<tbody class="list" id="table-latest-review-body">
								...
								<tr
									...
									<td
										class="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-700"><span
										class="badge badge-phoenix fs--2 badge-phoenix-warning"><span
											class="badge-label">Partial FulfiLled</span><span
						...
						<table class="table fs--1 mb-0">
							...
							<tbody class="list" id="customer-wishlist-table-body">
								<tr
									...
									<td class="products align-middle"><a
										class="fw-semi-bold mb-0" href="#!">Fitbit Sense Advanced
											Smartwatch wi...</a></td>
									<td
										class="color align-middle white-space-nowrap fs--1 text-900">Pure
										matt black</td>
									<td
								...
								<tr
									...
									<td class="products align-middle"><a
										class="fw-semi-bold mb-0" href="#!">2021 Apple 12.9-inch
											iPad Pro (Wi‑Fi, ...</a></td>
									<td
										class="color align-middle white-space-nowrap fs--1 text-900">Black</td>
									<td
								...
								<tr
									...
									<td class="products align-middle"><a
										class="fw-semi-bold mb-0" href="#!">PlayStation 5
											DualSense Wireless Cont...</a></td>
									<td
										class="color align-middle white-space-nowrap fs--1 text-900">White</td>
									<td
								...
								<tr
									...
									<td class="products align-middle"><a
										class="fw-semi-bold mb-0" href="#!">Apple MacBook Pro 13
											inch-M1-8/256G...</a></td>
									<td
										class="color align-middle white-space-nowrap fs--1 text-900">Space
										Gray</td>
									<td
										class="size align-middle white-space-nowrap text-700 fs--1 fw-semi-bold">Pro</td>
									<td
								...
								<tr
									...
									<td
										class="color align-middle white-space-nowrap fs--1 text-900">Ocean
										Blue</td>
									<td
