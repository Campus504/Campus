...
<!-- CSS -->
	<link rel="stylesheet" type="text/css" href="/campus/resources/assets/css/theme.min.css">
                      ...
                      <table class="table fs--1 mb-0">
                        ...
                        <tbody class="list" id="customer-wishlist-table-body">
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Fitbit Sense Advanced Smartwatch wi...</a></td>
                            <td class="color align-middle white-space-nowrap fs--1 text-900">Pure matt black</td>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, ...</a></td>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">PlayStation 5 DualSense Wireless Cont...</a></td>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Apple MacBook Pro 13 inch-M1-8/256G...</a></td>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Apple iMac 24&quot; 4K Retina Display M1 8 C...</a></td>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Apple Magic Mouse (Wireless, Recharg...</a></td>
                            <td class="color align-middle white-space-nowrap fs--1 text-900">White</td>
                            <td class="size align-middle white-space-nowrap text-700 fs--1 fw-semi-bold">Regular</td>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Amazon Basics Matte Black Wired Keybo...</a></td>
                            <td class="color align-middle white-space-nowrap fs--1 text-900">Black</td>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">HORI Racing Wheel Apex for PlayStation...</a></td>
                            <td class="color align-middle white-space-nowrap fs--1 text-900">Black</td>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Xbox Series S</a></td>
                            <td class="color align-middle white-space-nowrap fs--1 text-900">Space Gray</td>
