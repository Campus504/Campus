...
public interface GoodsMapper {
	...
	void insertOrderDetail(@Param("orderNo") int orderNumber, @Param("goodsCode")int code, @Param("amount") int goodsAmount, @Param("price") int goodsPrice);
	...
	@Select("SELECT c.memberId, c.amount, c.price, c.goodsCode, g.goodsName, g.category, g.brand FROM cart c inner join goods g on c.goodsCode = g.goodsCode  WHERE c.memberId =#{memberId}")
	...
	List<CartDto> selectCartByMemberId(String memberId);
