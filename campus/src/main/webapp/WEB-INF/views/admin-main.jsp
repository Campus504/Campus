	...
	<div class="header">
		...
		<div class="header-right">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								<li>
									<a href="#">
										<img src="/campus/resources/vendors/images/img.jpg" alt="">
										<h3>John Doe</h3>
								...
								<li>
									<a href="#">
										<img src="/campus/resources/vendors/images/photo1.jpg" alt="">
										<h3>Lea R. Frith</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/campus/resources/vendors/images/photo2.jpg" alt="">
								...
								<li>
									<a href="#">
										<img src="/campus/resources/vendors/images/photo3.jpg" alt="">
										<h3>John Doe</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/campus/resources/vendors/images/photo4.jpg" alt="">
			...
			<div class="github-link">
				<a href="https://github.com/dropways/deskapp" target="_blank"><img src="/campus/resources/vendors/images/github.svg" alt=""></a>
			</div>
		</div>
	</div>
				...
				<ul id="accordion-menu">
					...
					<li>
						<a href="https://dropways.github.io/deskapp-free-single-page-website-template/" target="_blank" class="dropdown-toggle no-arrow">
							...
							<span class="mtext">Landing Page <img src="/campus/resources/vendors/images/coming-soon.png" alt="" width="25"></span>
						</a>
					</li>
				</ul>
			</div>
			...
			<div class="card-box mb-30">
				...
				<table class="data-table table nowrap">
					...
					<tbody>
						<tr>
							<td class="table-plus">
								<img src="/campus/resources/vendors/images/product-1.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="/campus/resources/vendors/images/product-2.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="/campus/resources/vendors/images/product-3.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="/campus/resources/vendors/images/product-4.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="/campus/resources/vendors/images/product-5.jpg" width="70" height="70" alt="">
							</td>
							<td>
